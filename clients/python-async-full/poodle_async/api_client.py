...
from poodle_async.configuration import Configuration
from poodle_async.api_response import ApiResponse, T as ApiResponseT
import poodle_async.models
from poodle_async import rest
from poodle_async.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(poodle_async.models, klass)
